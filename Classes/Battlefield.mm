...
-(id) init {
	if((self = [super init])) {
		...
		HiyaAppDelegate* delegate = (HiyaAppDelegate*)[[UIApplication sharedApplication] delegate];
...
-(void) save {
	...
	NSString *savefile = [[HiyaAppDelegate documentDir] stringByAppendingPathComponent:SAVE_FILE_NAME];
